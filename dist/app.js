...
var app = new Vue({
  ...
  data: {
    // HEADER
    // Menu list
    headerMenu: ['Home', 'Rates', 'Testimonials', 'FAQ', 'Blog', 'Contact'],
    // Button
    ...
    // Menu lists
    footerMenu_1: ['Home', 'Rates', 'Testimonials', 'Blog', 'Free Quote'],
    footerMenu_2: ['Heading Out To College?', 'Moving Your Buisiness?', 'Outstanding Quality', 'Cost of Moving', 'Best Moving Tips'],
    //Copyright and Legal stuffs links
    copyAndLegal: ['© Copyright 2012 - 2020', 'Avada Theme by ThemeFusion', 'All Rights Reserved', 'Powered by Wordpress']
  }
});
